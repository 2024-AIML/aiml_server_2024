...
public class ShelterServiceTest {
    ...
    public void setup() {
        ...
        // firestore를 ShelterService에 주입
        shelterService = new ShelterService(firestore);
    }
    ...
    public void testGetShelterAddresses() throws ExecutionException, InterruptedException {
        ...
        shelter2.setFullAddress("456 Elm Street Apt 9");

        List<Shelter> mockShelters = Arrays.asList(shelter1, shelter2);
        ...
        when(queryDocumentSnapshot.toObject(Shelter.class))
                .thenReturn(shelter1)
                .thenReturn(shelter2);
